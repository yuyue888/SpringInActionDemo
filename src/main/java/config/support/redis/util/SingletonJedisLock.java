...
/**
 * <p>
 * 单实例Redis锁，应用于分布式远程锁同步
 * </p>
 *
 * @author Yangjs
 */
public class SingletonJedisLock {
     ...
     */
    public SingletonJedisLock(Jedis jedis, String lockKey) {
     ...
     */
    public SingletonJedisLock(Jedis jedis, String lockKey, int acquireTimeoutMillis) {
     ...
     */
    public SingletonJedisLock(Jedis jedis, String lockKey, int acquireTimeoutMillis, int expiryTimeMillis) {
     ...
     */
    public SingletonJedisLock(Jedis jedis, String lockKey, int acquireTimeoutMillis, int expiryTimeMillis, UUID uuid) {
        this.jedis = jedis;
        this.lockKeyPath = "SingletonLock_" + lockKey;
